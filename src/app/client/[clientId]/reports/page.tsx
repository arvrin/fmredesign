  ...
  return (
    <>
      ...
      <div className="mb-6 bg-fm-magenta-50 border border-fm-magenta-100 rounded-xl p-4 flex items-center space-x-3">
        <Activity className="w-5 h-5 text-fm-magenta-600 flex-shrink-0" />
        <p className="text-sm text-fm-magenta-800">
          <span className="font-semibold">Sample data.</span>{' '}
          Detailed performance reports will be shared by your account manager. Contact them for the latest metrics.
        </p>
      </div>
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            <Button variant="client" size="sm" disabled title="Reports will be available from your account manager">
              ...
              <Card key={report.id} variant="client" hover>
                ...
                <CardContent>
                  ...
                  <div className="flex items-center justify-between pt-3 border-t border-fm-neutral-100">
                    ...
                    <Button variant="ghost" size="sm" className="text-fm-magenta-600" disabled title="Reports will be available from your account manager">
                      <Download className="w-4 h-4 mr-2" />
                      Download
                    </Button>
                  </div>
          ...
          <Card variant="client" hover glow>
            <CardContent className="space-y-4 p-6">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h3 className="font-medium text-fm-neutral-900">Strong Traffic Growth</h3>
              ...
              <div className="flex items-start space-x-3">
                <div className="w-8 h-8 rounded-lg bg-fm-magenta-100 flex items-center justify-center flex-shrink-0">
                  <Award className="w-4 h-4 text-fm-magenta-600" />
                </div>
                <div>
                  <h3 className="font-medium text-fm-neutral-900">Improved Engagement</h3>
                  <p className="text-sm text-fm-neutral-600 mt-1">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h3 className="font-medium text-fm-neutral-900">Conversion Opportunity</h3>
                  <p className="text-sm text-fm-neutral-600 mt-1">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h3 className="font-medium text-fm-neutral-900">ROI Achievement</h3>
                  <p className="text-sm text-fm-neutral-600 mt-1">
