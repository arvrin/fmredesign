    ...
    (
      <div
        style={{
          ...
          position: 'relative',
          overflow: 'hidden',
          // Website's signature gradient background
      ...
      >
        ...
        <div
          style={{
            ...
            height: '300px',
            borderRadius: '50%',
            background: 'radial-gradient(ellipse, rgba(90, 15, 50, 0.14) 0%, transparent 55%)',
          }}
        />
