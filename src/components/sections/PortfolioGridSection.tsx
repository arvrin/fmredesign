...
const portfolioItems = {
  ...
  websites: [
    { src: '/work/websites/elisa_website.jpg', client: 'Elisa India', url: 'https://elisaindia.in', category: 'E-commerce' },
    ...
    { src: '/work/websites/restronaut_website.jpg', client: 'Restronaut', url: 'https://restronaut.in', category: 'SaaS' },
