...
const metricVariants = {
  default: {
    ...
    changeNeutral: 'text-fm-neutral-600 bg-fm-neutral-50'
  },
  admin: {
    card: 'admin',
      ...
      <Card variant={variantStyles.card as any} className={cn('relative', className)}>
        <div className="animate-pulse">
          <div className="flex items-center justify-between mb-4">
            <div className="h-4 bg-fm-neutral-200 rounded w-1/2"></div>
            <div className="h-6 w-6 bg-fm-neutral-200 rounded"></div>
          </div>
          <div className="h-8 bg-fm-neutral-200 rounded w-3/4 mb-2"></div>
          <div className="h-3 bg-fm-neutral-200 rounded w-1/3"></div>
        </div>
      </Card>
    );
  }
      ...
      <div className="relative">
        ...
        {change && (
          <div className={cn(
            ...
            <span className="text-fm-neutral-400">&bull;</span>
            <span className="text-fm-neutral-500">{change.period}</span>
          </div>
        )}
      </div>
    </Card>
...
export const MetricCardSkeleton: React.FC<{ className?: string }> = ({ className }) => (
  <Card className={cn('', className)}>
    <div className="animate-pulse">
      ...
      <div className="h-8 bg-fm-neutral-200 rounded w-3/4 mb-2"></div>
      <div className="h-5 bg-fm-neutral-200 rounded w-1/2"></div>
    </div>
  </Card>
);
